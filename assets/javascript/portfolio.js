...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            ...
            {
                name: 'Hover Carson On Top',
                link: ''
            },

            {
                name: 'DHover Carson#3600',
                link: ''
            },

            {
                name: 'www.Hover Carson.cf',
                link: ''
            }
        ];
        ...
        for (var i in links) {
            ...
            $('#marquee').append('<a href="https://discord.gg/GHrhqrsEbR' + link.link + '" target="_BLANK">' + link.name + '</a>');
        ...
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["Loading...", "Granting Access <span style='font-size: 14px; color: #06d;'>[:D]</span>..."], 30, function () {
                ...
                writeLine(["Access Granted! <span style='font-size: 14px; color: #0f0;'>[Success]</span>", "Welcome!<i style='color: #0f0'>" + 
                    ...
                    writeLine(["<i style='color: #F62459'>! $$$ Hover Carson $$$ !</i>"], 120, 500, function () {
